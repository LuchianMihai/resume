...
\vspace{0.1in} 
    ...
    \begin{itemize}
        \item{
            ...
            Mar 2022 - Present }
            \subitem{
                {\it Clasic AUTOSAR Basic software.\\
                Focus on COM stack and COM stack interaction.}
            }
    \end{itemize}
    ...
    \begin{itemize}
        \item{
            Intership Digital Design and Verification  
            {\it Focus on digital design verification using SystemVerilog and Cadence suite of tools.}\\
            Nov 2019 - Feb 2020 (4 mos) }
    \end{itemize}

    {\bf Transilvania University of Brasov,}
    \begin{itemize}
        \item{
            Research assistant\\
            Oct 2017 - Oct 2019 (2 yrs 1 mos) }
        \subitem{
            {\it RO-CERN collaboration, project ``ATLAS experiment at LHC''.\\
            Fields of interest: Hardware Design, Hardware Verification, Firmware Development, Product QA.\\
            Redacted Bachelor's degree Thesis
            }
        }
    \end{itemize}
    ...
    \begin{itemize}
        \item{
            Internship PCB Layout Designer. \\
            Jul 2017 - Oct 2017 (4 mos) }
        \subitem{
            {\it Worked on trainee projects using Altium Designer.\\
    ...
    {\bf Siemens Industry Software,}
    \begin{itemize}
        \item{
            Siemens Curious Minds 2016.\\
            Jul 2016 - Sep 2016 (3 mos) }
        \subitem{
            {\it Introduction to Software Development using C++.\\
            Introduction to Software Engineering: Compilation process, Project configuration.\\
            Introduction to Software Architecture: Design paterns, Libraries.\\
        ...
        \subitem{
            {\it Oriented Object Programming using C++ during summer school with emphasis
